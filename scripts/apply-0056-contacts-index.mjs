// Applies migrations/0056_contacts_company_id_index.sql and reports the result.
//
...
//
//   node --env-file-if-exists=.env scripts/apply-0056-contacts-index.mjs
//   node --env-file-if-exists=.env scripts/apply-0056-contacts-index.mjs --check
