...
const TARGETS = [
  ...
  ["focus_blocks",           "color",                "FocusBlockCreator → BuildPro"],
  ["takeoff_measurements",   "color",                "TakeoffColorPicker → BuildPro"],
  ["takeoff_markups",        "color",                "TakeoffColorPicker → BuildPro"],
  ["task_tags",              "color",                "TaskSettings → BuildPro"],
  ["task_templates",         "color",                "TaskSettings → BuildPro"],
  ["task_template_statuses", "color",                "TaskSettings → BuildPro"],
  ["field_options",          "color",                "FieldSettings → BuildPro"],
  ["custom_field_options",   "color",                "FieldSettings → BuildPro"],
  ["supplier_labels",        "color",                "Settings → BuildPro"],
  ["teams",                  "color",                "Settings → BuildPro"],
  ...
  ["projects",               "color",                "ProjectSettings → Project"],
];
