...
--   CREATE TABLE field_options_color_backup_0057 AS
--     SELECT id, color FROM field_options WHERE color IS NOT NULL;
--
-- Note: dev already carries a field_options_color_backup_0055 table from when
-- this migration was numbered 0055, before main landed its own 0054 and 0055.
-- Same contents; it is the pre-migration snapshot of the original 617 rows.
