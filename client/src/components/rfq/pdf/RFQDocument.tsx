    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.footer}>
          ...
          {/* The "confirm receipt" button that used to sit here linked to
              /rfqs/:id/confirm — a route that was never registered, so every
              supplier who clicked it landed on the not-found page. It also
              could not have worked in principle: one PDF goes to every
              supplier, so the link had no way to say WHO confirmed. Each
              recipient now gets their own tokenised portal link in the email
              body, which is the only place it can be correct. */}
          <Text style={[styles.footerText, { marginTop: 15, fontSize: 8 }]}>
            Generated by Morada • {formatDate(new Date())}
          </Text>
        </View>
      </Page>
    </Document>
