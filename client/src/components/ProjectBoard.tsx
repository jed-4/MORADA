  ...
  return (
    <div
      ...
      className={`rounded-xl border transition-all duration-200 ${
        isOver ? 'border-2 border-primary border-dashed bg-primary/5' : 'border-border/50 bg-muted/20'
      }`}
    >
      {/* Column Header */}
            ...
            <div key={i} className="w-80 flex-shrink-0 rounded-xl border border-border/50 bg-muted/20">
              <div className="px-3 py-2.5 border-b border-border/30 bg-muted/30">
                <div className="flex items-center justify-between">
                  ...
                  <Badge variant="secondary" className="text-xs px-2 py-0 h-5 rounded-full bg-primary/10 text-primary border-primary/20 font-semibold">...</Badge>
                </div>
              </div>
            ...
            >
              <div className="space-y-3">
                ...
                >
                  ...
                  <DragOverlay>
                    {activeField ? (
                      <div className="flex items-center gap-3 h-10 px-3 rounded-md border-2 bg-background border-primary shadow-lg opacity-80">
                        <GripVertical className="h-4 w-4 text-muted-foreground" />
