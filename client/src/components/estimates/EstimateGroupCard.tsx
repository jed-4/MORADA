    ...
    >
      ...
      {!isLocked && (
        <div
          {...attributes}
          {...listeners}
          className="absolute -left-8 top-0 h-10 w-8 flex items-center justify-center opacity-0 hover:opacity-100 cursor-grab active:cursor-grabbing transition-opacity z-20"
