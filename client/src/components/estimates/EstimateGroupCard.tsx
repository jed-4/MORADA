    ...
    >
      ...
      {!isLocked && (
        <div
          {...attributes}
          {...listeners}
          className="absolute -left-[22px] top-0 h-10 w-5 flex items-center justify-center opacity-0 group-hover/grp:opacity-100 cursor-grab active:cursor-grabbing transition-opacity z-20"
