import { Home, FolderOpen, CheckSquare, Calendar as CalendarIcon, Timer, MessageSquare, ClipboardList, Users, FileText, HardDrive, GanttChart, BarChart3, Wallet } from "lucide-react";
...
export const BUSINESS_TABS = [
  ...
  { id: "cashflow", label: "Cashflow", icon: Wallet, path: "/business/cashflow" },
