...
export default function Business() {
  ...
  return (
    <div className="flex flex-col h-full px-4 pt-2" data-testid="business-page">
      {/* Connected header with rounded corners */}
      <div className="border border-border rounded-t-lg bg-card flex-shrink-0">
        ...
        {/* Row 2 - Tabs */}
        <div className="h-8 flex items-center px-3 gap-4 overflow-x-auto">
      ...
      {/* Content Area - connected with rounded bottom */}
